...
public class Products extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session=new SessionManager(Products.this);
        ...
        RecyclerView.LayoutManager layoutRv = new GridLayoutManager(Products.this, 2, GridLayoutManager.VERTICAL, false);
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    Intent i = new Intent(Products.this, Search.class);
                    startActivity(i);
                }
                catch (Exception ignored)
                {
            ...
            public void onClick(View v) {
                {
                    try
                    {
                        final Dialog dialogs = new Dialog(Products.this);
                        ...
                        tv1.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                try {
                                    if (CheckNetwork.isInternetAvailable(Products.this))
                                    {
                                        sort_type = 1;
                                        resetProducts();
                                    }
        ...
        lay_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    final Dialog dialogs = new Dialog(Products.this, R.style.AppTheme_NoActionBar);
                    dialogs.requestWindowFeature(Window.FEATURE_NO_TITLE);
                    if( dialogs.getWindow()!=null)
                    {
                        dialogs.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                    ...
                    layoutManager1 = new LinearLayoutManager(Products.this, LinearLayoutManager.VERTICAL, false);
                        ...
                        try
                        {
                            ...
                            if(response.contains("Success"))
                            {
                                ...
                                if (!listBrands.isEmpty())
                                {
                                    ...
                                    brandsAdapter=new BrandsAdapter(Products.this,listBrands);
                        ...
                        try
                        {
                            ...
                            if (response.contains("Success"))
                            {
                                ...
                                if (!listCategory.isEmpty())
                                {
                                    ...
                                    categoryAdapter=new CategoryAdapter(listCategory,Products.this);
